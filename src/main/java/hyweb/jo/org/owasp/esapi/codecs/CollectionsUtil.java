 ...
 *
 * FIXME: we can convert to using this, but it requires that the array be of
 * Character, not char new HashSet(Arrays.asList(array))
 *
 */
public class CollectionsUtil {
     ...
     * @return character array containing the characters in str. An empty array
     ...
     *
     * @param str The string to convert
     * @return A set containing the characters in str. A empty set is returned
     * if str is null.
     */
