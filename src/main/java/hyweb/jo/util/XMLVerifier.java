...
public class XMLVerifier {
     ...
     * vertical tab, form-feed, etc.) are specifically excluded except for
    ...
    /**
     * This is a utility function for determining whether a specified String is
     * a whitespace character according to production 3 of the XML 1.0
     * specification.
     * <p>
     ...
     * @return true if all characters in the input value are all whitespace (or
